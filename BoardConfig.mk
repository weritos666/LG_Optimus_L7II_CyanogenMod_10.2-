...
-include vendor/lge/p713/BoardConfigVendor.mk

USE_CAMERA_STUB := true

TARGET_SPECIFIC_HEADER_PATH := device/lge/p713/include
...
TARGET_KERNEL_SOURCE := kernel/lge/p713/
TARGET_KERNEL_CONFIG := cyanogenmod10_2_vee7_defconfig
...
BOARD_KERNEL_CMDLINE :=  androidboot.hardware=vee7 msm_cpr.enable=0 lge.signed_image=false
ARCH_ARM_HAVE_TLS_REGISTER := true
BOARD_EGL_CFG := device/lge/p713/config/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/p713/bluetooth
...
# Recovery
TW_BOARD_CUSTOM_GRAPHICS := ../../../device/lge/p713/recovery/tw_graphics.c
